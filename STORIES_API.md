...
**Full OAuth2 + face role + curl walkthrough** (Slovak, step-by-step): in the **`mfai_demo` monorepo root**, see `doc/API_OAUTH_STORIES_CURL.md` (this file lives next to `be_demo/` / `fe_demo/`).
...
# 1) Register + OAuth2 token — see mfai_demo/doc/API_OAUTH_STORIES_CURL.md
